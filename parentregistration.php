...
<body>
<h2 class="modal-header text-primary">Parent Registration</h2>
...
<form action="registration.php" method="post">
    <div class="well container">
        ...
        <div class="col-lg-12 text-center">
            <input class="sigup btn btn-success" type="button" onclick="parentsignup();" id="register3" name="register3" value="Sign-Up">
        </div>
        <div id="showhere"></div>

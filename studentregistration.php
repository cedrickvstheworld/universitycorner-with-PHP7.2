...
<h2 class="modal-header text-primary">Student Registration</h2>
...
<form action="registration.php" method="post">
    <div class="well container">
        ...
        <div class="col-lg-12">
            ...
            <input type="tel" class="mobie maxlen11 input-lg" id="guardiancontact" name="guardiancontact" placeholder="Guardian's Contact No." required>
        </div>
        <div class="col-lg-12">
            <br>
        ...
        <div class="col-lg-12 text-center">
            <input class="sigup btn btn-success" type="button" onclick="studentsignup();" id="register2" name="register2" value="Sign-Up">
        </div>
